  ...
  return (
    <div>
          <div className='container'>
              <div class="mt-5 mb-5 text-center text-primary"><h2 style={{ color: '#7AB2B2'}}>Change Password</h2></div>
              <div class="row g-5 d-flex justify-content-center align-items-center">
                  <div class="col-4 text-center ">
                      <input placeholder='Current Password ' type="text" class="form-control" aria-describedby="passwordHelpInline" />
                  </div>
              </div>
