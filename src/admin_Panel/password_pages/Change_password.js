  ...
  return (
    <div>
          <div className='container'>
              <div className="mt-5 mb-5 text-center text-primary"><h2 style={{ color: '#7AB2B2'}}>Change Password</h2></div>
              <div className="row g-5 d-flex justify-content-center align-items-center">
                  <div className="col-4 text-center ">
                      <input placeholder='Current Password ' type="text" className="form-control" aria-describedby="passwordHelpInline" />
                  </div>
              </div>
